exports.config = {
  ...
  cucumberOpts: {
    ...
    strict: false, // <boolean> fail if there are any undefined or pending steps // <string[]> (expression) only execute the features or scenarios with tags matching the expression
